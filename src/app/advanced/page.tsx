            ...
            <div className="py-6 px-4 lg:px-8 overflow-x-hidden">
                <div className="max-w-4xl mx-auto space-y-6 overflow-hidden">
                    ...
                    <div className="flex flex-wrap gap-2">
                        ...
                        <TabButton active={activeTab === 'youtube-sandbox'} onClick={() => setActiveTab('youtube-sandbox')} icon={<FontAwesomeIcon icon={faYoutube} className="w-4 h-4" />} label="YT Sandbox" />
                    </div>
...
// ═══════════════════════════════════════════════════════════════
// YOUTUBE SANDBOX TAB - Embed Player Testing
// ═══════════════════════════════════════════════════════════════

function YouTubeSandboxTab() {
    const [url, setUrl] = useState('');
            ...
            <div className="glass-card p-5 space-y-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-[var(--text-muted)]">Test YouTube embed player - experimental capture testing</p>
                    </div>
                </div>
                ...
                <div className="flex gap-2">
                    <input
                        ...
                        className={`flex-1 min-w-0 text-sm px-3 py-2.5 rounded-lg bg-[var(--bg-secondary)] border ${error ? 'border-red-500/50' : 'border-[var(--border-color)]'} focus:border-[var(--accent-primary)] focus:outline-none`}
                    />
                    <Button onClick={handlePaste} variant={url.trim() ? 'secondary' : 'primary'} leftIcon={<Clipboard className="w-4 h-4" />}>
                ...
                {videoId && (
                    <div className="space-y-3 pt-4 border-t border-[var(--border-color)]">
                        <div className="flex items-center gap-2 text-xs text-[var(--text-muted)]">
                            <span>Video ID:</span>
                            <code className="px-2 py-1 rounded bg-[var(--bg-secondary)] font-mono">{videoId}</code>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <Button
                                ...
                                onClick={async () => {
                                    ...
                                    Swal.fire({ icon: 'success', title: 'Embed URL copied!', timer: 1500, showConfirmButton: false, background: 'var(--bg-card)', color: 'var(--text-primary)' });
                                }}
                        ...
                        <details className="group">
                            ...
                            <pre className="mt-2 p-3 rounded-lg bg-[var(--bg-secondary)] text-[10px] font-mono overflow-x-auto whitespace-pre-wrap break-all">
