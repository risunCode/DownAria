            ...
            <div className="py-6 px-4 lg:px-8">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            <p className="text-sm text-[var(--text-secondary)]">
                                <strong className="text-[var(--text-primary)]">💡 Pro Tip:</strong> You usually <strong>don't need</strong> to set up cookies! DownAria uses premium admin cookies automatically.
                                Only use this if the system is down or for specific private content. <Link href="/docs/guides/cookies" className="text-[var(--accent-primary)] hover:underline">Read Guide</Link>.
                            </p>
                        </motion.div>
                                        ...
                                        {platforms.map((p) => (
                                            <tr key={p.name} className="hover:bg-[var(--bg-secondary)] transition-colors">
                                                ...
                                                <td className="py-2.5 px-3">
                                                    <span className={`inline-flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full ${p.cookie === 'Not needed'
