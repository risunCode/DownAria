...
export const metadata: Metadata = {
    title: 'API Keys Guide - XTFetch Docs',
    description: 'How to create and manage API keys for higher rate limits and usage tracking in XTFetch.',
    keywords: ['API key', 'rate limits', 'authentication', 'API access'],
    openGraph: {
        title: 'API Keys Guide - XTFetch',
