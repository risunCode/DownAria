                    ...
                    <div className="space-y-6">
                        ...
                        >
                            <p className="text-sm text-[var(--text-secondary)]">
                                <strong className="text-blue-400">ℹ️ Do you need to do this?</strong><br />
                                <strong>Probably NOT!</strong> DownAria automatically uses premium admin cookies for downloads.
                                You only need to add your own cookies if the admin system is undergoing maintenance or for very specific private content.
                            </p>
                        </motion.div>
